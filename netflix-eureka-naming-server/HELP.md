...
* The original package name 'com.aaluni.microservices.netflix-eureka-naming-server' is invalid and this project uses 'com.aaluni.microservices.netflixeurekanamingserver' instead.
